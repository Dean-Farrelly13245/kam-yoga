...
const PhilosophySection = () => {
  return (
    <section className="py-20 lg:py-28 bg-sage/20">
      <div className="container mx-auto px-5 lg:px-8">
        ...
        <div className="max-w-3xl mx-auto text-center mb-14 lg:mb-20">
          ...
          <p className="mt-5 font-body text-base sm:text-lg text-muted-foreground leading-relaxed max-w-2xl mx-auto">
            At the core of Kam Yoga Sanctuary lies a simple belief: yoga is not about perfection, 
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 sm:gap-6 max-w-5xl mx-auto">
          {values.map((value, index) => {
            ...
            return (
              <div 
                key={index}
                className="group bg-background rounded-2xl p-6 sm:p-8 border border-border/60 hover:border-primary/30 hover:shadow-card transition-all duration-300"
              >
